...
ModifyTranslatedStrings("STRINGS.SKILLTREE.WENDY.WENDY_POTION_REVIVE_TITLE", "必忘忧")
...
STRINGS.UI.COOKBOOK.LETHEAN_CAKE = "遗忘亲和的立场"
STRINGS.UI.COOKBOOK.NIGHTMARE_LETHEAN_CAKE = "梦中的忘川河帮助你遗忘曾经的洞察"
...
STRINGS.ACTIONS.SPIRITUALISM = "通灵召唤"
STRINGS.CHARACTERS.WENDY.ACTIONFAIL.SPIRITUALISM = {
    NOTHOME = "我感觉到他们不在家里",
...
STRINGS.CHARACTERS.WENDY.DESCRIBE.MOON_TREE_BLOSSOM_LANTERN = ""
...
STRINGS.NAMES.FULLMOONBUTTERFLY = "满月蛾"
STRINGS.NAMES.EVILBUTTERFLY = "邪恶蝴蝶"
STRINGS.NAMES.DARKBUTTERFLY = "黑暗蝴蝶"

STRINGS.NAMES.LETHEAN_CAKE = "忘川蛋糕"
STRINGS.NAMES.NIGHTMARE_LETHEAN_CAKE = "梦魇忘川蛋糕"

STRINGS.CHARACTERS.WENDY.ANNOUNCE_SUMMON = "我想我需要你"
STRINGS.CHARACTERS.WENDY.ANNOUNCE_CONFIDE = "阿比盖尔我交到了新朋友"

STRINGS.CHARACTERS.WENDY.ANNOUNCE_REGAIN_GLORY = {
    DARK_BUTTERFLY = "帮它们重温荣耀",
    BUTTERFLY= "帮它们重温荣耀",
    FRUITFLY = "帮它们重温荣耀",
    CHESTER = "帮它们重温荣耀",
    HUTCH_FISHBOWL = "帮它们重温荣耀",
    MOON_TREE_BLOSSOM = "帮它们重温荣耀",
    FULLMOONBUTTERFLY = "它们获得了满月的荣耀",
    EVILBUTTERFLY = "暗影力量还不够重温荣耀",
    DARKBUTTERFLY = "暗影力量更强了，但还不够",
}
...
STRINGS.CHARACTERS.WENDY.ANNOUNCE_ABIGAIL_NORMAL_MOON = {
    GESTALT = "月亮正在盈满",
    GESTALT_CAVE  = "",
    SHADOW = "月亮正在亏缺",
    SHADOW_CAVE = "暗影在轻微涌动",
...
STRINGS.CHARACTERS.WENDY.ANNOUNCE_ABIGAIL_STRONG_MOON = {
    GESTALT = "更好更圆的月亮",
    GESTALT_CAVE  = "",
    SHADOW = "暗影蚀尽月亮",
    SHADOW_CAVE = "暗影在剧烈暴动",
...
STRINGS.CHARACTERS.WENDY.ANNOUNCE_ABIGAIL_HAUNT_TRANSFORM = {
    WEED_FORGETMELOTS = "阿比盖尔喜欢花园",
    WEED_FORGETMELOTS_BOLTING = "没有人应该被遗忘",
    EVIL_FORGETMELOTS = "阿比盖尔总是喜欢漂亮的花",
    EVIL_BLOSSOM = "阿比盖尔说月亮正在呼唤我",
}
