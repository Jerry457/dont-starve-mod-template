local files = {
    ...
    "postinit/map.lua",
    "postinit/components/avengingghost.lua",
    "postinit/components/burnable.lua",
    "postinit/components/clock.lua",
    "postinit/components/container.lua",
    ...
    "postinit/components/sheltered.lua",
    ...
    "postinit/prefabs/nightlight.lua",
